...
public class walkInPlaceS : MonoBehaviour {
	...
	void Update () 
	{
		if(character.allowWalkInPlace)
		{
            ...
            Debug.Log("distance left: " + (leftFootTrackerPos.leftFootPos.y - rightFootTrackerPos.rightFootPos.y).ToString() + " threshold: " + heightTheshold.ToString());
            Debug.Log("distance right: " + (rightFootTrackerPos.rightFootPos.y - leftFootTrackerPos.leftFootPos.y).ToString() + " threshold: " + heightTheshold.ToString());
            if (rightFootTrackerPos.rightFootPos.y - leftFootTrackerPos.leftFootPos.y > heightTheshold || Input.GetKey(KeyCode.RightArrow)) RightFootUp = true;
			else RightFootUp=false;
			if (leftFootTrackerPos.leftFootPos.y - rightFootTrackerPos.rightFootPos.y > heightTheshold || Input.GetKey(KeyCode.LeftArrow)) LeftFootUp = true;
