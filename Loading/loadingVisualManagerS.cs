...
public class loadingVisualManagerS : MonoBehaviour {
	...
	void Update () 
	{
		...
		{
			tutorialActive = false;
			if(GetComponent<AudioSource>().clip==voices[0] || GetComponent<AudioSource>().clip==voices[1] || GetComponent<AudioSource>().clip==voices[2] || GetComponent<AudioSource>().clip==voices[3] || GetComponent<AudioSource>().clip==voices[4] || GetComponent<AudioSource>().clip==voices[5]) GetComponent<AudioSource>().Stop();
		}		
		...
		{
			pictographsActive = false;
			if (GetComponent<AudioSource>().clip == voices[10] || GetComponent<AudioSource>().clip == voices[13] || GetComponent<AudioSource>().clip == voices[16]) GetComponent<AudioSource>().Stop();
		}		
	...
	void OnGUI()
	{
		if(tutorialActive) 
		{
			...
			case 0:
				...
				GetComponent<AudioSource>().clip = voices[tutorialSetNo*2];
			...
			case 3:
				...
				GetComponent<AudioSource>().clip = voices[tutorialSetNo*2 + 1];
				GetComponent<AudioSource>().Play();
				tutorialState++;
				break;
			case 4:
