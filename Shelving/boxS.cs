...
public class boxS : MonoBehaviour {
	...
	{
		boxModel.GetComponent<Renderer>().material.mainTexture = _tex;
	...
	{
		boxModel.GetComponent<Renderer>().material.mainTexture = null;
		labelObj.GetComponent<Renderer>().material.mainTexture = null;
		activeTexture = -1;
	}
	public void SetBoxWarning(bool _isWarning)
	{
		atWarning = _isWarning;
		if (_isWarning) boxModel.GetComponent<Renderer>().material.color = Color.red;
		else boxModel.GetComponent<Renderer>().material.color = Color.white;
	}
