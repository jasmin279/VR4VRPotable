...
public class otherCustomersS : MonoBehaviour
{
	...
	void Update()
	{
		...
		if (customers[0].isActive && (!customers[0].boxesActive || !customers[0].bagsActive))
		{
			...
			{
				customer1Instance.transform.GetChild(0).Find("master/Reference/Hips/Spine/Spine1/Spine2/LeftShoulder/LeftArm/LeftForeArm/LeftHand/Bag").GetComponent<Renderer>().enabled = true;
				customer1Instance.transform.GetChild(0).Find("master/Reference/Hips/Spine/Spine1/Spine2/RightShoulder/RightArm/RightForeArm/RightHand/Bag").GetComponent<Renderer>().enabled = true;
		...
		if (customers[1].isActive && (!customers[1].boxesActive || !customers[1].bagsActive))
		{
			...
			{
				customer2Instance.transform.GetChild(0).Find("master/Reference/Hips/Spine/Spine1/Spine2/LeftShoulder/LeftArm/LeftForeArm/LeftHand/Bag").GetComponent<Renderer>().enabled = true;
				customer2Instance.transform.GetChild(0).Find("master/Reference/Hips/Spine/Spine1/Spine2/RightShoulder/RightArm/RightForeArm/RightHand/Bag").GetComponent<Renderer>().enabled = true;
